...
func (t *Tree) newIdentifier(ident string, pos Pos) *IdentifierNode {
...
// PipeVariableNode holds a list of variable names, possibly with chained field
// accesses. The dollar sign is part of the (first) name.
type PipeVariableNode struct {
	NodeType
	Pos
	tr    *Tree
...
func (t *Tree) newPipeVariable(pos Pos, ident string) *PipeVariableNode {
	return &PipeVariableNode{tr: t, NodeType: NodePipeVariable, Pos: pos, Ident: strings.Split(ident, ".")}
}

func (v *PipeVariableNode) String() string {
	var sb strings.Builder
	v.writeTo(&sb)
	return sb.String()
}

func (v *PipeVariableNode) writeTo(sb *strings.Builder) {
...
func (v *PipeVariableNode) tree() *Tree {
	return v.tr
}

func (v *PipeVariableNode) Copy() Node {
	return &VariableNode{tr: v.tr, NodeType: NodePipeVariable, Pos: v.Pos, Ident: append([]string{}, v.Ident...)}
}
