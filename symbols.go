...
// SymbolMap is the type of the map defining the mapping from names to functions.
...
type SymbolMap map[string]any

// builtins returns the FuncMap.
// It is not a global variable so the linker can dead code eliminate
// more when this isn't called. See golang.org/issue/36021.
// TODO: revert this back to a global map once golang.org/issue/2559 is fixed.
func builtins() SymbolMap {
	return SymbolMap{
		"and":      and,
		"call":     call,
		"html":     HTMLEscaper,
...
// findSymbol looks for a function in the template, and global map.
func findSymbol(name string, tmpl *Template) (v reflect.Value, isBuiltin, ok bool) {
